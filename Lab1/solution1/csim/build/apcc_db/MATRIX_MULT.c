...
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = sext i32 %%storemerge3 to i64, !dbg !5 for 0x%I64xth hint within @initializeMatrixA  --> \n", ++aesl_llvm_cbe_11_count);
...
llvm_cbe_tmp__9:
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = add nsw i32 %%storemerge3, 1, !dbg !6 for 0x%I64xth hint within @initializeMatrixA  --> \n", ++aesl_llvm_cbe_24_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = tail call i32 @rand() nounwind, !dbg !5 for 0x%I64xth hint within @initializeMatrixA  --> \n", ++aesl_llvm_cbe_13_count);
  llvm_cbe_tmp__2 = (unsigned int ) /*tail*/ rand();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__2);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = trunc i32 %%3 to i8, !dbg !5 for 0x%I64xth hint within @initializeMatrixA  --> \n", ++aesl_llvm_cbe_14_count);
  llvm_cbe_tmp__3 = (unsigned char )((unsigned char )llvm_cbe_tmp__2&255U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__3);
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = sext i32 %%storemerge12 to i64, !dbg !5 for 0x%I64xth hint within @initializeMatrixA  --> \n", ++aesl_llvm_cbe_15_count);
  llvm_cbe_tmp__4 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge12);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = getelementptr inbounds [64 x i8]* %%A, i64 %%1, i64 %%5, !dbg !5 for 0x%I64xth hint within @initializeMatrixA  --> \n", ++aesl_llvm_cbe_16_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i8 %%4, i8* %%6, align 1, !dbg !5 for 0x%I64xth hint within @initializeMatrixA  --> \n", ++aesl_llvm_cbe_17_count);
  *llvm_cbe_tmp__5 = llvm_cbe_tmp__3;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__3);
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = add nsw i32 %%storemerge12, 1, !dbg !6 for 0x%I64xth hint within @initializeMatrixA  --> \n", ++aesl_llvm_cbe_18_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = sext i32 %%storemerge3 to i64, !dbg !5 for 0x%I64xth hint within @initializeMatrixB  --> \n", ++aesl_llvm_cbe_41_count);
...
llvm_cbe_tmp__19:
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = add nsw i32 %%storemerge3, 1, !dbg !6 for 0x%I64xth hint within @initializeMatrixB  --> \n", ++aesl_llvm_cbe_54_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = tail call i32 @rand() nounwind, !dbg !5 for 0x%I64xth hint within @initializeMatrixB  --> \n", ++aesl_llvm_cbe_43_count);
  llvm_cbe_tmp__12 = (unsigned int ) /*tail*/ rand();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__12);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = trunc i32 %%3 to i8, !dbg !5 for 0x%I64xth hint within @initializeMatrixB  --> \n", ++aesl_llvm_cbe_44_count);
  llvm_cbe_tmp__13 = (unsigned char )((unsigned char )llvm_cbe_tmp__12&255U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__13);
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = sext i32 %%storemerge12 to i64, !dbg !5 for 0x%I64xth hint within @initializeMatrixB  --> \n", ++aesl_llvm_cbe_45_count);
  llvm_cbe_tmp__14 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge12);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__14);
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = getelementptr inbounds [64 x i8]* %%B, i64 %%1, i64 %%5, !dbg !5 for 0x%I64xth hint within @initializeMatrixB  --> \n", ++aesl_llvm_cbe_46_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i8 %%4, i8* %%6, align 1, !dbg !5 for 0x%I64xth hint within @initializeMatrixB  --> \n", ++aesl_llvm_cbe_47_count);
  *llvm_cbe_tmp__15 = llvm_cbe_tmp__13;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__13);
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = add nsw i32 %%storemerge12, 1, !dbg !6 for 0x%I64xth hint within @initializeMatrixB  --> \n", ++aesl_llvm_cbe_48_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = sext i32 %%storemerge5 to i64, !dbg !6 for 0x%I64xth hint within @matrixMultiplication  --> \n", ++aesl_llvm_cbe_80_count);
...
llvm_cbe_tmp__38:
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = add nsw i32 %%storemerge5, 1, !dbg !6 for 0x%I64xth hint within @matrixMultiplication  --> \n", ++aesl_llvm_cbe_117_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = sext i32 %%storemerge14 to i64, !dbg !6 for 0x%I64xth hint within @matrixMultiplication  --> \n", ++aesl_llvm_cbe_82_count);
  llvm_cbe_tmp__22 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge14);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__22);
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = getelementptr inbounds [64 x i32]* %%AB, i64 %%1, i64 %%3, !dbg !6 for 0x%I64xth hint within @matrixMultiplication  --> \n", ++aesl_llvm_cbe_83_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i32 0, i32* %%4, align 4, !dbg !6 for 0x%I64xth hint within @matrixMultiplication  --> \n", ++aesl_llvm_cbe_84_count);
  *llvm_cbe_tmp__23 = 0u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", 0u);
...
llvm_cbe_tmp__41:
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = add nsw i32 %%storemerge14, 1, !dbg !7 for 0x%I64xth hint within @matrixMultiplication  --> \n", ++aesl_llvm_cbe_109_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = sext i32 %%storemerge23 to i64, !dbg !5 for 0x%I64xth hint within @matrixMultiplication  --> \n", ++aesl_llvm_cbe_91_count);
  llvm_cbe_tmp__24 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge23);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__24);
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = getelementptr inbounds [64 x i8]* %%A, i64 %%1, i64 %%6, !dbg !5 for 0x%I64xth hint within @matrixMultiplication  --> \n", ++aesl_llvm_cbe_92_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = load i8* %%7, align 1, !dbg !5 for 0x%I64xth hint within @matrixMultiplication  --> \n", ++aesl_llvm_cbe_93_count);
  llvm_cbe_tmp__26 = (unsigned char )*llvm_cbe_tmp__25;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__26);
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = zext i8 %%8 to i32, !dbg !5 for 0x%I64xth hint within @matrixMultiplication  --> \n", ++aesl_llvm_cbe_94_count);
  llvm_cbe_tmp__27 = (unsigned int )((unsigned int )(unsigned char )llvm_cbe_tmp__26&255U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__27);
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = getelementptr inbounds [64 x i8]* %%B, i64 %%6, i64 %%3, !dbg !5 for 0x%I64xth hint within @matrixMultiplication  --> \n", ++aesl_llvm_cbe_95_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = load i8* %%10, align 1, !dbg !5 for 0x%I64xth hint within @matrixMultiplication  --> \n", ++aesl_llvm_cbe_96_count);
  llvm_cbe_tmp__29 = (unsigned char )*llvm_cbe_tmp__28;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__29);
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = zext i8 %%11 to i32, !dbg !5 for 0x%I64xth hint within @matrixMultiplication  --> \n", ++aesl_llvm_cbe_97_count);
  llvm_cbe_tmp__30 = (unsigned int )((unsigned int )(unsigned char )llvm_cbe_tmp__29&255U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__30);
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = mul nsw i32 %%12, %%9, !dbg !5 for 0x%I64xth hint within @matrixMultiplication  --> \n", ++aesl_llvm_cbe_98_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = load i32* %%4, align 4, !dbg !5 for 0x%I64xth hint within @matrixMultiplication  --> \n", ++aesl_llvm_cbe_99_count);
  llvm_cbe_tmp__32 = (unsigned int )*llvm_cbe_tmp__23;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__32);
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = add i32 %%13, %%14, !dbg !5 for 0x%I64xth hint within @matrixMultiplication  --> \n", ++aesl_llvm_cbe_100_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%15, i32* %%4, align 4, !dbg !5 for 0x%I64xth hint within @matrixMultiplication  --> \n", ++aesl_llvm_cbe_101_count);
  *llvm_cbe_tmp__23 = llvm_cbe_tmp__33;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__33);
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = add nsw i32 %%storemerge23, 1, !dbg !7 for 0x%I64xth hint within @matrixMultiplication  --> \n", ++aesl_llvm_cbe_102_count);
