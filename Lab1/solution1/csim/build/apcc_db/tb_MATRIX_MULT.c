...
void matrixMultiplication( char (*)[64],  char (*)[64], signed int (*)[64]);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @matrixMultiplication([64 x i8]* %%9, [64 x i8]* %%10, [64 x i32]* %%11) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_18_count);
  matrixMultiplication(llvm_cbe_tmp__9, llvm_cbe_tmp__10, llvm_cbe_tmp__11);
if (AESL_DEBUG_TRACE) {
}
