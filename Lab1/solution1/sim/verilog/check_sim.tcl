...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.matrixMultiplication.autotvin_A.dat"
         "c.matrixMultiplication.autotvin_B.dat"
         "c.matrixMultiplication.autotvin_AB.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.matrixMultiplication.autotvout_AB.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
