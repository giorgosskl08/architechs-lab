...
if {[file isfile matrixMultiplication.autotvin.dat]} {
	file delete -force matrixMultiplication.autotvin.dat
}

if {[file isfile matrixMultiplication.autotvout.dat]} {
	file delete -force matrixMultiplication.autotvout.dat
}
