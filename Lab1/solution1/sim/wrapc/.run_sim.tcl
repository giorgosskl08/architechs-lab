...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "matrixMultiplication.autotvin.dat"
	set constFileTvOut       "matrixMultiplication.autotvout.dat"
	set constFileHdlTvIn     "matrixMultiplication.autohdltvin.dat"
	set constFileHdlTvOut    "matrixMultiplication.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
