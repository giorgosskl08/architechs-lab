...
$(ObjDir)/tb_MATRIX_MULT.c_pre.c.tb.o : tb_MATRIX_MULT.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) tb_MATRIX_MULT.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/MATRIX_MULT.c_pre.c.tb.o : MATRIX_MULT.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) MATRIX_MULT.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
